...
IF %ERRORLEVEL% NEQ 0 (
    echo.
    echo  VS Code no encontrado en esta PC.
...
:: Oracle SQL Developer (conexion y ejecucion de SQL/PLSQL)
...
echo.
echo ╔══════════════════════════════════════════════╗
echo ║   Todo listo. Instrucciones de conexion:     ║
echo ║                                              ║
...
echo ║   Service    : xe                            ║
echo ║                                              ║
echo ║   Orden de ejecucion de scripts:             ║
echo ║   01 → 02 → 03 → 04 → 05 → 06 → 07         ║
echo ║                                              ║
echo ║   Para ver el ER: abrir ER_AUTOFIX.md        ║
